...
CONFIG <- list(
  functions_rds_url = "https://raw.githubusercontent.com/Onhech/OHEP/main/ohepR/displayr_payload/latest/sources/template_functions_bundle.rds",
  static_bundle_rds_url = "https://raw.githubusercontent.com/Onhech/OHEP/main/ohepR/displayr_payload/latest/sources/template_static_bundle.rds"
)
