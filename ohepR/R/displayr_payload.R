...
build_displayr_function_reference <- function() {
  ...
  docs <- list(
    ...
    write_displayr_template_bootstrap = list(
      ...
      details = c(
        "The single script `displayr_payload/displayr_bootstrap_single_paste.R` is intended for copy/paste into one Displayr R Output.",
        "Users edit only the `DATASET_MAP` block."
      ),
